...
// import type { lazyMinting } from "../typechain-types/contracts";
// import { ERC721Lazy, LazyNFT } from "../typechain-types";
...
//     const result = await signLazyMint(tokenAddr, tokenId, minPrice, uri, user1);
