...
//     const NFTFactory = await ethers.getContractFactory("ERC6551NFT");
...
//     const RegistryFactory = await ethers.getContractFactory("ERC6561Registry");
...
//       .withArgs(expectedAddr, account.target, 1337, nft.target, tokenId, salt);
